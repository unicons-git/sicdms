...
public class CalendarUtil {
	...
	//요일(한글) 배열
	private static final String[] DAY_OF_WEEK_KO = {
		"일", "월", "화", "수", "목", "금", "토"
	};
	...
	public static String getDayOfWeek(Calendar cal) {
		if(cal == null) return "";
		String returnDay = DAY_OF_WEEK[cal.get(Calendar.DAY_OF_WEEK) - 1];
		return returnDay;
	}
	...
	public static String getDayOfWeekKo(Calendar cal) {
		if(cal == null) return "";
		String returnDay = DAY_OF_WEEK_KO.clone()[cal.get(Calendar.DAY_OF_WEEK) - 1].toString();
		return returnDay;
	}
