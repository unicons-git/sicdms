...
public class EgovSpringSecurityLogoutFilter implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		((HttpServletRequest)request).getSession().setAttribute("member", null);
		...
		((HttpServletResponse)response).sendRedirect(((HttpServletRequest)request).getContextPath() + "/login/login.do");
	}
